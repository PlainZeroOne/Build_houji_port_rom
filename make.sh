...
vendor_zip_name=$(echo ${VENDOR_URL} | cut -d"/" -f5)            # 底包的 zip 名称, 例: miui_ruby_OS1.0.32.0.UNCCNXM_4fd0e15877_14.0.zip
...
zip_md5=${md5:0:10}
rom_name="miui_ruby_${port_os_version}_${zip_md5}_${android_version}.0_YuKongA.zip"
